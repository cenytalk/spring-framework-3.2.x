...
public abstract class AbstractDetectingUrlHandlerMapping extends AbstractUrlHandlerMapping {
	...
	public void initApplicationContext() throws ApplicationContextException {
		...
		//建立当前ApplicationContext中所有的Controller和Url的对应关系
		detectHandlers();
	}
	 ...
	 */
	protected void detectHandlers() throws BeansException {//建立当前ApplicationContext中的所有controller和url的对应关系
		...
		for (String beanName : beanNames) {
			//找bean上所有的url(Controller上的url+方法上的url),该方法由对应的子类实现
	 ...
	 */
	protected abstract String[] determineUrlsForHandler(String beanName);//获取Controller中所有方法的url,由子类实现，典型的模板模式
