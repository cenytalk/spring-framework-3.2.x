...
public class DefaultBeanDefinitionDocumentReader implements BeanDefinitionDocumentReader {
	 ...
	 */
	public void registerBeanDefinitions(Document doc, XmlReaderContext readerContext) {//根据Spring DTD对Bean的定义规则解析Bean定义Document对象
		//获得XML描述符
	...
	protected BeanDefinitionParserDelegate createDelegate(
			XmlReaderContext readerContext, Element root, BeanDefinitionParserDelegate parentDelegate) {//创建BeanDefinitionParserDelegate，用于完成真正的解析过程
	 ...
	 */
	protected void importBeanDefinitionResource(Element ele) {//解析<import>导入元素，从给定的导入路径加载Bean定义资源到Spring IOC容器中
