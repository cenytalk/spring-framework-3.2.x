...
public abstract class AbstractBeanFactory extends FactoryBeanRegistrySupport implements ConfigurableBeanFactory {
	...
	public Object getBean(String name) throws BeansException {//获取IOC容器中指定名称的Bean
		//doGetBean才是真正向IOC容器获取被管理Bean的过程
		return doGetBean(name, null, null, false);
	}

	public <T> T getBean(String name, Class<T> requiredType) throws BeansException {//获取IOC容器中指定名称和类型的Bean
		//doGetBean才是真正向IOC容器获取被管理Bean的过程
		return doGetBean(name, requiredType, null, false);
	}

	public Object getBean(String name, Object... args) throws BeansException {//获取IOC容器中指定名称和参数的Bean
		//doGetBean才是真正向IOC容器获取被管理Bean的过程
	 ...
	 */
	public <T> T getBean(String name, Class<T> requiredType, Object... args) throws BeansException {//获取IOC容器中指定名称、类型和参数的Bean
		//doGetBean才是真正向IOC容器获取被管理Bean的过程
	...
	protected <T> T doGetBean(
			...
			throws BeansException {//真正实现向IOC容器获取Bean的功能，也是触发依赖注入功能的地方
	...
	protected Object getObjectForBeanInstance(
		...
		//如果Bean实例不是工厂Bean,或者指定名称是容器的引用
		//调用者想获取对容器的引用，则直接返回当前的Bean实例
		if (!(beanInstance instanceof FactoryBean) || BeanFactoryUtils.isFactoryDereference(name)) {
			return beanInstance;
		}
